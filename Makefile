...
PROGS:= test_two_averages test_array_averages
...
# "test_two_averages" is the name of the file that's generated
# "test_two_averages.o, stats.o, and ../unity/unity.o" is the list of files to compile
# The $(CC) line tells Make what to do
test_two_averages: test_two_averages.o stats.o ../unity/unity.o
	$(CC) ${LDFLAGS} $^ -o $@
